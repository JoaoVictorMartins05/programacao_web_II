...
namespace Projeto_WEB_2.Areas.Identity.Pages.Account
{
    public class RegisterModelNutricionista : PageModel
    {
        ...
        public RegisterModelNutricionista(
            ...
            IEmailSender emailSender, db_IF_WEB_IIContext context)
        {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    if (result.Succeeded)
                    {
                        _logger.LogInformation("User 'Nutricionista' created a new account with password.");
            ...
            ViewData["IdPlano"] = new SelectList(_context.TbPlano, "IdPlano", "Nome", Input.tbProfissional.IdContratoNavigation);
